...
namespace WindowsFormsApp.publishSubscribe
{
    public class ArrivalsMonitor : IObserver<BaggageInfo>
    {
        ...
        public string ShowSingleMsg
        {
            get { return _tempMsg; }
            set { _tempMsg = value; OnChanged(_tempMsg, null); }
        }
        ...
        public virtual void OnNext(BaggageInfo info)
        {
            ...
            else
            {
                ...
                if (!flightInfos.Contains(flightInfo))
                {
                    ...
                    updated = true;
                    ShowSingleMsg = $"{info.FlightNumber},{info.From}";
                }
            }
            if (updated)
            {
